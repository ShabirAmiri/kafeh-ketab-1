...
if (isset($_REQUEST['id'])) {
  $search = htmlentities($_REQUEST['id']);
  $get_book = "SELECT * FROM books WHERE bname like '%$search%' or aname like '%$search%' or genre like '%$search%'";
  $run_book = mysqli_query($conn, $get_book);
  $book_lists = mysqli_fetch_all($run_book, MYSQLI_ASSOC);
}
  ...
  <body>
    ...
    <section class="main-section">
      ...
      <div class="part2" id="top">
        ...
        <h2 class="bestbook head-one">Search Results</h2>
          ...
          <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="10000">
              ...
              <div class="row row-design">
                  <?php  foreach($book_lists as $book_list) {?>
                    <?php 
                  $bookid = $book_list['bookid'];
                  $bname = $book_list['bname'];
                  $aname = $book_list['aname'];
